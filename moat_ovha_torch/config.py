...
class Phase15Config:
    ...
    adapter_auxiliary_loss_weight: float = 0.0
    primitive_output_loss_weight: float = 0.0
    oracle_routed_prediction_loss_weight: float = 0.0
    param_scope_loss_weight: float = 0.0
